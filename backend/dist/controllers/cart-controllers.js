...
exports.createOrder =
  exports.removeAllItemsFromCart =
  exports.removeItemFromCart =
  exports.totalItemsInCart =
  exports.viewCart =
...
const addItemToCart = (req, res, next) => {
  ...
  db_1.default.query(
    cart_queries_1.addOrSetItemToCartQuery[operation],
...
const viewCart = (req, res, next) => {
  ...
  db_1.default.query(
    ...
    (error, results) => {
      ...
      const cart = ((_a = results.rows[0]) === null || _a === void 0
        ? void 0
        : _a.cart) || { items: [], total_price: 0 };
...
const totalItemsInCart = (req, res, next) => {
  const userId = req.user.userId;
  db_1.default.query(
    cart_queries_1.totalItemsInCartQuery,
    [userId],
    (error, results) => {
      if (error) {
        return next((0, error_1.default)(500, "Error fetching cart items"));
...
const removeItemFromCart = (req, res, next) => {
  ...
  db_1.default.query(
    cart_queries_1.removeItemFromCartQuery,
    [userId, itemId],
    (error, results) => {
      if (error) {
...
const removeAllItemsFromCart = (req, res, next) => {
  const userId = req.user.userId;
  db_1.default.query(
    cart_queries_1.removeAllItemsFromCartQuery,
    [userId],
    (error, results) => {
...
const createOrder = (req, res, next) => {
  ...
  db_1.default.query(
    cart_queries_1.createOrderQuery,
